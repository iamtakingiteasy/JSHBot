...
import org.eientei.jshbot.bundles.service.connectionmanager.actions.ConnectAction;
import org.eientei.jshbot.bundles.service.connectionmanager.actions.DisconnectAction;
import org.eientei.jshbot.bundles.service.connectionmanager.actions.ListConnections;
...
public class ConnectionManager extends InterruptableThread implements Subscriber {
    ...
    private void bindProtocol(Protocol protocol) {
        protocols.put(protocol.getScheme(), protocol);
        String[] uris = protocol.autoConnectURIs();
    ...
    @Unbind()
    private void unbindProtocol(Protocol protocol) {
        Protocol proto = protocols.remove(protocol.getScheme());
